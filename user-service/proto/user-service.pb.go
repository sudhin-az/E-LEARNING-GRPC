...
const file_user_service_proto_user_service_proto_rawDesc = "" +
	"\n" +
	"%user-service/proto/user-service.proto\x12\x04user\"7\n" +
	...
	".user.UserR\x05users2n\n" +
	"\vUserService\x123\n" +
	"\n" +
	"CreateUser\x12\x11.user.UserRequest\x1a\x12.user.UserResponse\x12*\n" +
	"\vGetAllUsers\x12\v.user.Empty\x1a\x0e.user.UserListB9Z7github.com/sudhin-az/E-LEARNING-GRPC/user-service/protob\x06proto3"
...
var file_user_service_proto_user_service_proto_depIdxs = []int32{
	...
	2, // 2: user.UserService.GetAllUsers:input_type -> user.Empty
	1, // 3: user.UserService.CreateUser:output_type -> user.UserResponse
	4, // 4: user.UserService.GetAllUsers:output_type -> user.UserList
